...
function OoyalaApiClient(apiKey, apiSecret, hostName, hostPort, ttl) {
  this.apiKey = apiKey;
  this.apiSecret = apiSecret;
  this.expiresInSeconds = ttl ? ttl : 30;
...
OO._.extend(OoyalaApiClient.prototype, {
  ...
  remove: function(headers, apiPath, params, statusCb, dataCb, errCb, context) {
    this._curl('DELETE', headers, apiPath, params, null, statusCb, dataCb, errCb, context);
  },
